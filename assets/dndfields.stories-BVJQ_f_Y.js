import{j as o,r as f}from"./iframe-Bjw1izuO.js";import{D as se,S as F,a as re,M as me,b as ce,c as pe,d as ue,T as he,e as le}from"./index-DBwzK3do.js";import{n as m}from"./index.browser-OxPLOBIU.js";import{S as L}from"./index-DZOTKW-4.js";import{B as y}from"./index-B5KEZiQy.js";import{A}from"./AddIcon-z0NTHNW0.js";import"./index-ClNI1SK7.js";import"./type-Bc9hys3F.js";import"./index-crTNFZzi.js";import"./index-DvYm1l1E.js";import"./useOutsideToggle-lx1OPIt2.js";import"./DropdownIcon-CE5Ej-H_.js";import"./SearchIcon-Zq8RB_pg.js";import"./Text-DPvCpjk2.js";import"./ImportExportIcon-KdrUIRAO.js";import"./FilledIcon-eGs_y6Cd.js";import"./index-DCCbEvUK.js";import"./index-BYmlidqC.js";import"./EditIcon-CYLHp7do.js";import"./CheckmarkIcon-CHRszheK.js";import"./CloseIcon-CKWAzZoU.js";const Re={title:"PAC Universal Plugin UI/Primitive/Draggable Fields",component:se},ge=[{id:m(),label:"Primary",color:"#000000",isDefault:!0,colorOpacity:1},{id:m(),label:"Secondary",color:"#FF0000",isDefault:!0,colorOpacity:1}],x={render:()=>{const[i,a]=f.useState(ge),I=n=>{const{active:d,over:e}=n;if(!e||d.id===e.id)return;const t=i.findIndex(c=>c.id===d.id),l=i.findIndex(c=>c.id===e.id);if(t===-1||l===-1)return;const r=[...i],[u]=r.splice(t,1);u&&r.splice(l,0,u),a(r)},g=(n,d)=>{a(e=>e.map(t=>t.id===n?{...t,label:d}:t))},C=(n,d)=>{a(e=>e.map(t=>t.id===n?{...t,color:d}:t))},s=(n,d)=>{a(e=>e.map(t=>t.id===n?{...t,colorOpacity:d}:t))},p=n=>{a(d=>d.filter(e=>e.id!==n))},h=()=>{const n={id:m(),label:`New Color ${i.length+1}`,color:"#888888",colorOpacity:1};a(d=>[...d,n])};return o.jsxs(L,{children:[o.jsx(F,{onDragEnd:I,items:i.map(n=>n.id),children:i.map(n=>o.jsx(se,{id:n.id,label:n.label,color:n.color,colorOpacity:n.colorOpacity,setColorOpacity:d=>s(n.id,d),onLabelChange:d=>g(n.id,d),onColorChange:d=>C(n.id,d),onDeleteHandle:()=>p(n.id),isDefault:n.isDefault},n.id))}),o.jsx(y,{onClick:h,leftIcon:A,children:"Add New Custom Color"})]})}},Ie=[{id:m(),label:"Google",url:"https://www.google.com",target:"New Tab"},{id:m(),label:"Docs",url:"https://docs.example.com",target:"Same Tab",asChild:!0}],b={render:()=>{const[i,a]=f.useState(Ie),I=({active:n,over:d,delta:e})=>{const t=i.findIndex(r=>r.id===n.id),l=i.findIndex(r=>r.id===d.id);a(r=>{const u=[...r],[c]=u.splice(t,1);return c&&(u.splice(l,0,c),(e==null?void 0:e.x)>50?c.asChild=!0:(e==null?void 0:e.x)<-50&&(c.asChild=!1)),u[0]&&(u[0].asChild=!1),u})},g=(n,d)=>{a(e=>e.map(t=>t.id===n?{...t,label:d}:t))},C=(n,d)=>{a(e=>e.map(t=>t.id===n?{...t,url:d}:t))},s=(n,d)=>{a(e=>e.map(t=>t.id===n?{...t,target:d}:t))},p=n=>{a(d=>d.filter(e=>e.id!==n))},h=()=>{const n={id:m(),label:`New Link ${i.length+1}`,url:"",target:"New Tab"};a(d=>[...d,n])};return o.jsxs(L,{children:[o.jsx(F,{onDragEnd:I,items:i.map(n=>n.id),restrictToVerticalAxisValue:!1,children:i.map(n=>o.jsx(re,{id:n.id,label:n.label,url:n.url,asChild:n.asChild,target:n.target,onLabelChange:d=>g(n.id,d),onUrlChange:d=>C(n.id,d),onSelectChange:d=>s(n.id,d),onDeleteHandle:()=>p(n.id)},n.id))}),o.jsx(y,{onClick:h,leftIcon:A,children:"Add New Custom Link"})]})}},w={render:()=>o.jsx(me,{dashIconslug:"",url:"",onSlugChange:i=>console.log(i),onURLChange:i=>console.log(i)})},Ce=[{id:m(),fontName:"Poppins Classic",fontWeights:"300, 400, 500, 600"},{id:m(),fontName:"Roboto Mono",fontWeights:"100, 300, 400"}],D={render:()=>{const[i,a]=f.useState(Ce),I=({active:s,over:p})=>{const h=i.findIndex(d=>d.id===s.id),n=i.findIndex(d=>d.id===p.id);h===-1||n===-1||a(d=>{const e=[...d],[t]=e.splice(h,1);return t&&e.splice(n,0,t),e})},g=s=>{a(p=>p.filter(h=>h.id!==s))},C=()=>{const s={id:m(),fontName:`New Font ${i.length+1}`,fontWeights:""};a(p=>[...p,s])};return o.jsxs(L,{children:[o.jsx(F,{onDragEnd:I,items:i.map(s=>s.id),children:i.map(s=>o.jsx(ce,{id:s.id,fontName:s.fontName,fontWeights:s.fontWeights,onDeleteHandle:()=>g(s.id)},s.id))}),o.jsx(y,{onClick:C,leftIcon:A,children:"Add New Custom Font"})]})}},S={render:()=>o.jsx(pe,{id:"preset-1"})},E={render:()=>o.jsx(ue,{id:"replace-field-1"})},fe=[{id:"template-1",title:"Template 1"},{id:"template-2",title:"Template 2"},{id:"template-3",title:"Template 3"}],k={render:()=>o.jsx(he,{role:"Administrator",templates:fe,selectedTemplateId:"",placeholder:"Select a template",onSelectChange:i=>alert(`selected Templates is : ${i}`)})},v=()=>{const[i,a]=f.useState(!1);return o.jsx(le,{id:"test-template",isEditable:i,onEditClick:()=>a(!0),onEditComplete:()=>a(!1)})},ve=[{id:m(),name:"Default Template",isDefault:!0},{id:m(),name:"Custom Header Template"},{id:m(),name:"Minimal Template"}],T={render:()=>{const[i,a]=f.useState(ve),[I,g]=f.useState(new Set),C=e=>{const{active:t,over:l}=e;if(!l||t.id===l.id)return;const r=i.findIndex(N=>N.id===t.id),u=i.findIndex(N=>N.id===l.id);if(r===-1||u===-1)return;const c=[...i],[j]=c.splice(r,1);j&&c.splice(u,0,j),a(c)},s=(e,t)=>{a(l=>l.map(r=>r.id===e?{...r,name:t}:r))},p=e=>{g(t=>new Set(t).add(e))},h=e=>{g(t=>{const l=new Set(t);return l.delete(e),l})},n=e=>{a(t=>t.filter(l=>l.id!==e)),g(t=>{const l=new Set(t);return l.delete(e),l})},d=()=>{const e={id:m(),name:`New Template ${i.length+1}`};a(t=>[...t,e])};return o.jsxs(L,{children:[o.jsx(F,{onDragEnd:C,items:i.map(e=>e.id),children:i.map(e=>o.jsx(le,{id:e.id,name:e.name,isDefault:e.isDefault,isEditable:I.has(e.id),onEditClick:()=>p(e.id),onEditComplete:()=>h(e.id),onNameChange:t=>s(e.id,t),onDeleteHandle:()=>n(e.id),onCopyClick:()=>alert(`Copied template: ${e.name}`)},e.id))}),o.jsx(y,{onClick:d,leftIcon:A,children:"Add New Template"})]})}};v.__docgenInfo={description:"",methods:[],displayName:"TemplateFieldSingle"};var O,P,$;x.parameters={...x.parameters,docs:{...(O=x.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: () => {
