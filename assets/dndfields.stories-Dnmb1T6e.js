import{j as o,r as f}from"./iframe-C_4GIzKJ.js";import{D as se,S as F,a as re,M as me,b as ce,c as pe,d as ue,T as he,e as le}from"./index-DfhigBlA.js";import{S as L}from"./index-BuuCRCUi.js";import{B as A}from"./index-cI3hA5az.js";import{A as y}from"./AddIcon-FQ8yeUd2.js";import"./index-COvJscgd.js";import"./type-Bc9hys3F.js";import"./index-B_3UFFmA.js";import"./index-CPbor_uM.js";import"./useOutsideToggle-Cn3-BZ1E.js";import"./DropdownIcon-BIy6e6DS.js";import"./SearchIcon-rTmhpz2t.js";import"./Text-D975vQw0.js";import"./ImportExportIcon-B8_Nwqsz.js";import"./FilledIcon-BoZD7w7I.js";import"./index-zNVgYdSC.js";import"./index-BoGxgBsl.js";import"./CheckmarkIcon-hhWro0gx.js";import"./CloseIcon-C8UZEaBT.js";const ge="useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict";let m=(i=21)=>{let a="",g=crypto.getRandomValues(new Uint8Array(i|=0));for(;i--;)a+=ge[g[i]&63];return a};const Re={title:"PAC Universal Plugin UI/Primitive/Draggable Fields",component:se},Ie=[{id:m(),label:"Primary",color:"#000000",isDefault:!0,colorOpacity:1},{id:m(),label:"Secondary",color:"#FF0000",isDefault:!0,colorOpacity:1}],x={render:()=>{const[i,a]=f.useState(Ie),g=e=>{const{active:d,over:n}=e;if(!n||d.id===n.id)return;const t=i.findIndex(c=>c.id===d.id),l=i.findIndex(c=>c.id===n.id);if(t===-1||l===-1)return;const r=[...i],[u]=r.splice(t,1);u&&r.splice(l,0,u),a(r)},I=(e,d)=>{a(n=>n.map(t=>t.id===e?{...t,label:d}:t))},C=(e,d)=>{a(n=>n.map(t=>t.id===e?{...t,color:d}:t))},s=(e,d)=>{a(n=>n.map(t=>t.id===e?{...t,colorOpacity:d}:t))},p=e=>{a(d=>d.filter(n=>n.id!==e))},h=()=>{const e={id:m(),label:`New Color ${i.length+1}`,color:"#888888",colorOpacity:1};a(d=>[...d,e])};return o.jsxs(L,{children:[o.jsx(F,{onDragEnd:g,items:i.map(e=>e.id),children:i.map(e=>o.jsx(se,{id:e.id,label:e.label,color:e.color,colorOpacity:e.colorOpacity,setColorOpacity:d=>s(e.id,d),onLabelChange:d=>I(e.id,d),onColorChange:d=>C(e.id,d),onDeleteHandle:()=>p(e.id),isDefault:e.isDefault},e.id))}),o.jsx(A,{onClick:h,leftIcon:y,children:"Add New Custom Color"})]})}},Ce=[{id:m(),label:"Google",url:"https://www.google.com",target:"New Tab"},{id:m(),label:"Docs",url:"https://docs.example.com",target:"Same Tab",asChild:!0}],b={render:()=>{const[i,a]=f.useState(Ce),g=({active:e,over:d,delta:n})=>{const t=i.findIndex(r=>r.id===e.id),l=i.findIndex(r=>r.id===d.id);a(r=>{const u=[...r],[c]=u.splice(t,1);return c&&(u.splice(l,0,c),(n==null?void 0:n.x)>50?c.asChild=!0:(n==null?void 0:n.x)<-50&&(c.asChild=!1)),u[0]&&(u[0].asChild=!1),u})},I=(e,d)=>{a(n=>n.map(t=>t.id===e?{...t,label:d}:t))},C=(e,d)=>{a(n=>n.map(t=>t.id===e?{...t,url:d}:t))},s=(e,d)=>{a(n=>n.map(t=>t.id===e?{...t,target:d}:t))},p=e=>{a(d=>d.filter(n=>n.id!==e))},h=()=>{const e={id:m(),label:`New Link ${i.length+1}`,url:"",target:"New Tab"};a(d=>[...d,e])};return o.jsxs(L,{children:[o.jsx(F,{onDragEnd:g,items:i.map(e=>e.id),restrictToVerticalAxisValue:!1,children:i.map(e=>o.jsx(re,{id:e.id,label:e.label,url:e.url,asChild:e.asChild,target:e.target,onLabelChange:d=>I(e.id,d),onUrlChange:d=>C(e.id,d),onSelectChange:d=>s(e.id,d),onDeleteHandle:()=>p(e.id)},e.id))}),o.jsx(A,{onClick:h,leftIcon:y,children:"Add New Custom Link"})]})}},w={render:()=>o.jsx(me,{dashIconslug:"",url:"",onSlugChange:i=>console.log(i),onURLChange:i=>console.log(i)})},fe=[{id:m(),fontName:"Poppins Classic",fontWeights:"300, 400, 500, 600"},{id:m(),fontName:"Roboto Mono",fontWeights:"100, 300, 400"}],D={render:()=>{const[i,a]=f.useState(fe),g=({active:s,over:p})=>{const h=i.findIndex(d=>d.id===s.id),e=i.findIndex(d=>d.id===p.id);h===-1||e===-1||a(d=>{const n=[...d],[t]=n.splice(h,1);return t&&n.splice(e,0,t),n})},I=s=>{a(p=>p.filter(h=>h.id!==s))},C=()=>{const s={id:m(),fontName:`New Font ${i.length+1}`,fontWeights:""};a(p=>[...p,s])};return o.jsxs(L,{children:[o.jsx(F,{onDragEnd:g,items:i.map(s=>s.id),children:i.map(s=>o.jsx(ce,{id:s.id,fontName:s.fontName,fontWeights:s.fontWeights,onDeleteHandle:()=>I(s.id)},s.id))}),o.jsx(A,{onClick:C,leftIcon:y,children:"Add New Custom Font"})]})}},S={render:()=>o.jsx(pe,{id:"preset-1"})},E={render:()=>o.jsx(ue,{id:"replace-field-1"})},ve=[{id:"template-1",title:"Template 1"},{id:"template-2",title:"Template 2"},{id:"template-3",title:"Template 3"}],k={render:()=>o.jsx(he,{role:"Administrator",templates:ve,selectedTemplateId:"",placeholder:"Select a template",onSelectChange:i=>alert(`selected Templates is : ${i}`)})},v=()=>{const[i,a]=f.useState(!1);return o.jsx(le,{id:"test-template",isEditable:i,onEditClick:()=>a(!0),onEditComplete:()=>a(!1)})},xe=[{id:m(),name:"Default Template",isDefault:!0},{id:m(),name:"Custom Header Template"},{id:m(),name:"Minimal Template"}],T={render:()=>{const[i,a]=f.useState(xe),[g,I]=f.useState(new Set),C=n=>{const{active:t,over:l}=n;if(!l||t.id===l.id)return;const r=i.findIndex(N=>N.id===t.id),u=i.findIndex(N=>N.id===l.id);if(r===-1||u===-1)return;const c=[...i],[j]=c.splice(r,1);j&&c.splice(u,0,j),a(c)},s=(n,t)=>{a(l=>l.map(r=>r.id===n?{...r,name:t}:r))},p=n=>{I(t=>new Set(t).add(n))},h=n=>{I(t=>{const l=new Set(t);return l.delete(n),l})},e=n=>{a(t=>t.filter(l=>l.id!==n)),I(t=>{const l=new Set(t);return l.delete(n),l})},d=()=>{const n={id:m(),name:`New Template ${i.length+1}`};a(t=>[...t,n])};return o.jsxs(L,{children:[o.jsx(F,{onDragEnd:C,items:i.map(n=>n.id),children:i.map(n=>o.jsx(le,{id:n.id,name:n.name,isEditable:g.has(n.id),onEditClick:()=>p(n.id),onEditComplete:()=>h(n.id),onNameChange:t=>s(n.id,t),onDeleteHandle:()=>e(n.id)},n.id))}),o.jsx(A,{onClick:d,leftIcon:y,children:"Add New Template"})]})}};v.__docgenInfo={description:"",methods:[],displayName:"TemplateFieldSingle"};var O,P,U;x.parameters={...x.parameters,docs:{...(O=x.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: () => {
