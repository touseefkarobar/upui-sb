import{j as o,r as C}from"./iframe-CRG9BGu-.js";import{D as U,S as f,a as ke,M as Le,b as Te,c as ye,d as Se,e as Fe,T as Ae,f as Ee,g as Ne}from"./index-TzHGJB6Z.js";import{g as p}from"./generateId-C1v-VC-6.js";import{S as b}from"./index-Dfe6r8sF.js";import{B as D}from"./index-CifSDP94.js";import{A as w}from"./AddIcon-h3fiA6zQ.js";import{A as Ve,M as je,B as Oe,C as Me}from"./MediaLibraryIcon-DojRdW94.js";import"./index-BT1XktgY.js";import"./type-CgT0EiC8.js";import"./index-ChoG4d2E.js";import"./index-C3i3SvKA.js";import"./useOutsideToggle-DsYSfLfE.js";import"./DropdownIcon-BGUHuiea.js";import"./SearchIcon-Ds8lW-h5.js";import"./FilledIcon-CVlV6JOW.js";import"./ResetIcon-R78H6TN-.js";import"./index-ByOx_Jes.js";import"./index-BN5F9dM3.js";import"./index-CNCGTCB9.js";import"./Heading-D6Qq-17u.js";import"./CloseIcon-yuoYjFte.js";import"./index-BPup0kjA.js";import"./index-CkUvyNKQ.js";import"./index-CQQn9YrY.js";import"./Text-CYdK4AbI.js";import"./TrashIcon-ohifrESc.js";import"./ImportExportIcon-CJ1JdpLb.js";import"./EditIcon-CoRbRSu4.js";import"./CheckmarkIcon-BJDmsa1g.js";import"./CopyIcon-oVuqHK-_.js";import"./index-KP8vP-ng.js";import"./index-BOzOlBpZ.js";import"./index-Ct2Uit2a.js";import"./RolesIcon-TrzXfLva.js";const En={title:"PAC Universal Plugin UI/Primitive/DnD Fields",component:U},Ue=[{id:p(),label:"Primary",color:"#000000",isDefault:!0,colorOpacity:1},{id:p(),label:"Secondary",color:"#FF0000",isDefault:!0,colorOpacity:1}],S={render:()=>{const[d,a]=C.useState(Ue),I=n=>{const{active:i,over:e}=n;if(!e||i.id===e.id)return;const t=d.findIndex(h=>h.id===i.id),m=d.findIndex(h=>h.id===e.id);if(t===-1||m===-1)return;const g=[...d],[v]=g.splice(t,1);v&&g.splice(m,0,v),a(g)},r=(n,i)=>{a(e=>e.map(t=>t.id===n?{...t,label:i}:t))},l=(n,i)=>{a(e=>e.map(t=>t.id===n?{...t,color:i}:t))},s=(n,i)=>{a(e=>e.map(t=>t.id===n?{...t,colorOpacity:i}:t))},c=n=>{a(i=>i.filter(e=>e.id!==n))},u=()=>{const n={id:p(),label:`New Color ${d.length+1}`,color:"#888888",colorOpacity:1};a(i=>[...i,n])};return o.jsxs(b,{children:[o.jsx(f,{onDragEnd:I,items:d.map(n=>n.id),children:d.map(n=>o.jsx(U,{id:n.id,label:n.label,color:n.color,colorOpacity:n.colorOpacity,setColorOpacity:i=>s(n.id,i),onLabelChange:i=>r(n.id,i),onColorChange:i=>l(n.id,i),onDeleteHandle:()=>c(n.id),isDefault:n.isDefault,enableConfirmation:!0,popupDirection:"down"},n.id))}),o.jsx(D,{onClick:u,leftIcon:w,children:"Add New Custom Color"})]})}},E={render:()=>{const[d,a]=C.useState("#ff0000"),[I,r]=C.useState(1);return o.jsx(U,{id:2,label:"Color Field Label",color:d,onColorChange:a,colorOpacity:I,setColorOpacity:r,onLabelChange:()=>{},onDeleteHandle:()=>{},isVariable:!0,variableTitle:"Primary",popupDirection:"down"})}},Re=[{id:p(),label:"Google",url:"https://www.google.com",target:"New Tab"},{id:p(),label:"Docs",url:"https://docs.example.com",target:"Same Tab",asChild:!0}],k={render:()=>{const[d,a]=C.useState(Re),I=({active:n,over:i,delta:e})=>{const t=d.findIndex(g=>g.id===n.id),m=d.findIndex(g=>g.id===i.id);a(g=>{const v=[...g],[h]=v.splice(t,1);return h&&(v.splice(m,0,h),(e==null?void 0:e.x)>50?h.asChild=!0:(e==null?void 0:e.x)<-50&&(h.asChild=!1)),v[0]&&(v[0].asChild=!1),v})},r=(n,i)=>{a(e=>e.map(t=>t.id===n?{...t,label:i}:t))},l=(n,i)=>{a(e=>e.map(t=>t.id===n?{...t,url:i}:t))},s=(n,i)=>{a(e=>e.map(t=>t.id===n?{...t,target:i}:t))},c=n=>{a(i=>i.filter(e=>e.id!==n))},u=()=>{const n={id:p(),label:`New Link ${d.length+1}`,url:"",target:"New Tab"};a(i=>[...i,n])};return o.jsxs(b,{children:[o.jsx(f,{onDragEnd:I,items:d.map(n=>n.id),restrictToVerticalAxisValue:!1,children:d.map(n=>o.jsx(ke,{id:n.id,label:n.label,url:n.url,asChild:n.asChild,target:n.target,onLabelChange:i=>r(n.id,i),onUrlChange:i=>l(n.id,i),onSelectChange:i=>s(n.id,i),onDeleteHandle:()=>c(n.id)},n.id))}),o.jsx(D,{onClick:u,leftIcon:w,children:"Add New Custom Link"})]})}},L={render:()=>o.jsx(Le,{dashIconslug:"",url:"",onSlugChange:d=>console.log(d),onURLChange:d=>console.log(d)})},Be=[{id:p(),fontName:"Poppins Classic",fontWeights:"300, 400, 500, 600"},{id:p(),fontName:"Roboto Mono",fontWeights:"100, 300, 400"}],T={render:()=>{const[d,a]=C.useState(Be),I=({active:s,over:c})=>{const u=d.findIndex(i=>i.id===s.id),n=d.findIndex(i=>i.id===c.id);u===-1||n===-1||a(i=>{const e=[...i],[t]=e.splice(u,1);return t&&e.splice(n,0,t),e})},r=s=>{a(c=>c.filter(u=>u.id!==s))},l=()=>{const s={id:p(),fontName:`New Font ${d.length+1}`,fontWeights:""};a(c=>[...c,s])};return o.jsxs(b,{children:[o.jsx(f,{onDragEnd:I,items:d.map(s=>s.id),children:d.map(s=>o.jsx(Te,{id:s.id,fontName:s.fontName,fontWeights:s.fontWeights,onDeleteHandle:()=>r(s.id)},s.id))}),o.jsx(D,{onClick:l,leftIcon:w,children:"Add New Custom Font"})]})}},y={render:()=>o.jsx(ye,{id:"preset-1"})},F={render:()=>o.jsx(Se,{id:"replace-field-1",placeholders:["Video Title","Video URL"]})},A={render:()=>o.jsx(Se,{id:"replace-field-error-1",placeholders:["Video Title","Video URL"],cssSelectorError:"*Invalid Title",customTextError:"*Invalid link"})},Pe=[{id:p(),name:"Accordion",icon:Ve},{id:p(),name:"Audio",icon:je},{id:p(),name:"Bar Counter",icon:Oe},{id:p(),name:"Code",icon:Me}],N={render:()=>{const[d,a]=C.useState(Pe),I=r=>{const{active:l,over:s}=r;!s||l.id===s.id||a(c=>{const u=c.findIndex(t=>t.id===l.id),n=c.findIndex(t=>t.id===s.id);if(u===-1||n===-1)return c;const i=[...c],[e]=i.splice(u,1);return e&&i.splice(n,0,e),i})};return o.jsx(f,{onDragEnd:I,items:d.map(r=>r.id),children:d.map(r=>o.jsx(Fe,{id:r.id,moduleName:r.name,moduleIcon:r.icon},r.id))})}},$e=[{id:"template-1",title:"Template 1"},{id:"template-2",title:"Template 2"},{id:"template-3",title:"Template 3"}],V={render:()=>o.jsx(Ae,{role:"Administrator",templates:$e,selectedTemplateId:"",placeholder:"Select a template",onSelectChange:d=>alert(`selected Templates is : ${d}`)})},x=()=>{const[d,a]=C.useState(!1);return o.jsx(Ee,{id:"test-template",isEditable:d,onEditClick:()=>a(!0),onEditComplete:()=>a(!1)})},He=[{id:p(),name:"Default Template",isDefault:!0,assigned:!0,assignedToRoles:["Administrator","Editor","Publisher","SEO"],usersList:[{src:"https://i.pravatar.cc/150?img=1",alt:"User 1",userName:"John Doe"},{src:"https://i.pravatar.cc/150?img=2",alt:"User 2",userName:"Jane Smith"},{src:"https://i.pravatar.cc/150?img=3",alt:"User 3",userName:"Bob Wilson"},{src:"https://i.pravatar.cc/150?img=4",alt:"User 4",userName:"Alice Brown"},{src:"https://i.pravatar.cc/150?img=5",alt:"User 5",userName:"Charlie Davis"}]},{id:p(),name:"Custom Header Template",assigned:!0,assignedToRoles:["Manager","Reviewer"],usersList:[{src:"https://i.pravatar.cc/150?img=1",alt:"User 1",userName:"John Doe"}]},{id:p(),name:"Minimal Template"}],j={render:()=>{const[d,a]=C.useState(He),[I,r]=C.useState(new Set),l=e=>{const{active:t,over:m}=e;if(!m||t.id===m.id)return;const g=d.findIndex(M=>M.id===t.id),v=d.findIndex(M=>M.id===m.id);if(g===-1||v===-1)return;const h=[...d],[R]=h.splice(g,1);R&&h.splice(v,0,R),a(h)},s=(e,t)=>{a(m=>m.map(g=>g.id===e?{...g,name:t}:g))},c=e=>{console.log("Editing Clicked:",e),r(t=>new Set(t).add(e))},u=e=>{r(t=>{const m=new Set(t);return m.delete(e),m})},n=e=>{a(t=>t.filter(m=>m.id!==e)),r(t=>{const m=new Set(t);return m.delete(e),m})},i=()=>{const e={id:p(),name:`New Template ${d.length+1}`};a(t=>[...t,e])};return o.jsxs(b,{children:[o.jsx(f,{onDragEnd:l,items:d.map(e=>e.id),children:d.map((e,t)=>o.jsx(Ee,{id:e.id,name:e.name,isDefault:e.isDefault,isEditable:I.has(e.id),onEditClick:()=>c(e.id),onEditComplete:()=>u(e.id),onNameChange:m=>s(e.id,m),onDeleteHandle:()=>n(e.id),onCopyClick:()=>alert(`Copied template: ${e.name}`),usersList:e.usersList,roles:e.assignedToRoles,variant:"secondary",description:t===d.length-1?"What a description":void 0},e.id))}),o.jsx(D,{onClick:i,leftIcon:w,children:"Add New Template"})]})}},We=[{id:p(),label:"Video Title 1",module:"Module A"},{id:p(),label:"Video Title 2",module:"Module B"}],O={render:()=>{const[d,a]=C.useState(We),I=l=>{const{active:s,over:c}=l;if(!c||s.id===c.id)return;const u=d.findIndex(t=>t.id===s.id),n=d.findIndex(t=>t.id===c.id);if(u===-1||n===-1)return;const i=[...d],[e]=i.splice(u,1);e&&i.splice(n,0,e),a(i)},r=()=>{const l={id:p(),label:`New Video ${d.length+1}`,module:"Module"};a(s=>[...s,l])};return o.jsxs(b,{children:[o.jsx(f,{onDragEnd:I,items:d.map(l=>l.id),children:d.map(l=>o.jsx(Ne,{id:l.id,label:l.label,module:l.module,onEditClick:()=>alert("Edit Clicked"),onDeleteHandle:()=>alert("Delete Clicked")},l.id))}),o.jsx(D,{onClick:r,leftIcon:w,children:"Add New Video"})]})}};x.__docgenInfo={description:"",methods:[],displayName:"TemplateFieldSingle"};var B,P,$;S.parameters={...S.parameters,docs:{...(B=S.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => {
